...
class ZIW_Lookup extends ZIW_Base
{
	...
	function GetInputSpecifier()
	{
		...
		$includeYDE = strlen(Zymurgy::YUI("yahoo-dom-event/yahoo-dom-event.js"));
		$yuiIncludes .= $includeYDE > 0
			? "includeJS('".Zymurgy::YUIBaseURL()."yahoo-dom-event/yahoo-dom-event.js"."');\n"
			: "";

		$includeConnection = strlen(Zymurgy::YUI("connection/connection-min.js"));
		$yuiIncludes .= $includeConnection > 0
			? "includeJS('".Zymurgy::YUIBaseURL()."connection/connection-min.js"."');\n"
			: "";
//		die("Includes: ".$includeYDE.", ".$includeConnection.": ".$yuiIncludes);
