			...
			<table>
				...
				<tr>
					<td colspan="2" align="center">
						<input style="width: 80px; margin-right: 10px;" type="button" value="OK" onClick="SaveTheme();">
						<input style="width: 80px; margin-right: 10px;" type="button" value="Cancel" onClick="window.close();">
					</td>
				</tr>
			</table>
		</form>
